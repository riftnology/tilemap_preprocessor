  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="container mx-auto px-3 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h1 className="text-lg font-bold">Tilemap Editor</h1>
            </div>
          ...
          <div className="flex gap-3">
            <div className="flex-shrink-0 w-72">
              ...
              <div className="bg-white rounded-lg shadow-md p-3 mt-3">
                <h2 className="text-base font-medium mb-2 text-gray-700">Selected Tile</h2>
                {selectedTile ? (
                  ...
                  <p className="text-gray-500 text-center italic text-sm">No tile selected</p>
                )}
              </div>
              
              <div className="bg-white rounded-lg shadow-md p-3 mt-3">
                <h2 className="text-base font-medium mb-2 text-gray-700">Instructions</h2>
      ...
      <footer className="bg-gray-800 text-gray-400 py-2 mt-auto">
        <div className="container mx-auto px-3 text-center text-xs">
